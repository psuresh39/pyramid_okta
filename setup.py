...
try:
    with open('pyramid_okta/_version.py', 'r') as f:
        content = f.read()
...
class tag(Command):
    ...
    def run(self):
        ...
        with open('./pyramid_okta/_version.py', 'w') as f:
...
setup(
    ...
    description='Bindings for the pyramid webframework and the Okta authorization system.',
    license='MIT',
    keywords='',
